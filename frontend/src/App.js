...
function App() {
  const [messages, setMessages] = useState([
    {
      sender: "bot",
      text: "Namaste! Ask me a question or switch to offline mode to see saved answers.",
    },
  ]);
  ...
  return (
    <div className="container">
      <header>
        {/* The widgets are now CHILDREN of the header */}
      ...
      <form className="input-area" onSubmit={handleFormSubmit}>
        <input
          ...
          placeholder={
            isListening ? "Listening..." : "Type or click the mic..."
          }
          autoComplete="off"
          disabled={isThinking}
        />
